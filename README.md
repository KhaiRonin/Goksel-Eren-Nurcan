...
- **NanoCity Tycoon (Unity, C#)** – Grid-based city builder with resource economy, building placement, boost mechanics, and save system.
- **Wrench Garage Service Platform (Flutter, Firestore)** – Real-time job tracking, invoicing, and cross-device sync for auto service businesses.
- **Fortune Teller Mobile App (Flutter, Firebase)** – User journey, paywall integration, live notifications, and content tooling.
...
- GitHub: [@KhaiRonin](https://github.com/KhaiRonin)
